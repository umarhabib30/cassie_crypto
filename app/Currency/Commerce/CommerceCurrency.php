...
use App\Currency\Commerce\Utils\CoinpaymentsCommerce;
...
abstract class CommerceCurrency extends Currency {
  ...
  abstract function coinpaymentsId(): string;

  function newWalletAddress(?\App\Models\User $user, ?string $chainId = null): string {
    return CoinpaymentsCommerce::generateWalletAddress($this, $user);
  }
