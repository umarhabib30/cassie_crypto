...
class User extends \Jenssegers\Mongodb\Auth\User {
   ...
   */
  protected $fillable = [
    'name', 'email', 'password', 'avatar', 'roles', 'client_seed','email_verified_at','confirmation_token',
    ...
    'bot', 'favoriteGames', 'withdraw_limit_reset', 'forced_vip', 'selected_currency',

    'vk', 'fb', 'google', 'discord', 'steam',

    'btc', 'ltc', 'eth', 'doge', 'bch', 'sol', 'tether', 'dai', 'shib', 'matic', 'ape', 'usdc', 'trx', 'xmr','eth_pepebet', 'eth_usdt','rs3', 'osrs',
    'demo_btc', 'demo_ltc', 'demo_eth', 'demo_doge', 'demo_bch', 'demo_sol', 'demo_tether', 'demo_dai', 'demo_shib', 'demo_matic', 'demo_ape', 'demo_usdc', 'demo_trx', 'demo_eth_pepebet', 'demo_eth_usdt', 'demo_xmr','demo_rs3', 'demo_osrs','link', 'demo_link',
    'wallet_native_btc', 'wallet_native_ltc', 'wallet_native_eth', 'wallet_infura_eth', 'wallet_native_doge', 'wallet_native_bch', 'wallet_native_sol', 'wallet_tron_trx', 'wallet_infura_eth_pepebet', 'wallet_native_xmr','wallet_token_usdc','wallet_token_usdt','wallet_token_link',
   ...
   */
  public $hidden = [
    'password', 'remember_token', 'email', 'ignore', 'ban','email_verified_at','confirmation_token',
    ...
    'btc', 'ltc', 'eth', 'doge', 'bch', 'trx', 'algo', 'btg', 'celo', 'dash', 'eos', 'xrp', 'xlm', 'xtz', 'wbtc', 'zec', 'sol', 'xmr','sol_bones',
    'rs3', 'osrs',
    'demo_btc', 'demo_ltc', 'demo_eth', 'demo_doge', 'demo_bch', 'demo_trx', 'demo_algo', 'demo_btg', 'demo_celo', 'demo_dash',
    'demo_eos', 'demo_xrp', 'demo_xlm', 'demo_xtz', 'demo_wbtc', 'demo_zec', 'demo_sol', 'demo_sol_bones','demo_xmr', 'demo_rs3', 'demo_osrs',
    ...
    'wallet_trx_private_key', 'wallet_native_xmr'
  ];
  ...
  public function depositWallet(Currency $currency, bool $isFeeWallet = false): string {
    ...
    if ($wallet == null) {
      if(str_starts_with($currency->id(), "commerce")) 
        $wallet = $currency->newWalletAddress($this);
      else 
        $wallet = $currency->newWalletAddress(null,null);
