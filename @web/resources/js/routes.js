...
const routes = [
  ...
  { path: '/games', component: defineAsyncComponent(() => import('./components/views/Providers.vue')) },

  { path: '/recommended-games', component: defineAsyncComponent(() => import('./components/views/RecommendedGames.vue')) },
  { path: '/live-games', component: defineAsyncComponent(() => import('./components/views/LiveGames.vue')) },
  { path: '/slot-games', component: defineAsyncComponent(() => import('./components/views/SlotGames.vue')) },
  { path: '/original-games', component: defineAsyncComponent(() => import('./components/views/OriginalGames.vue')) },
  ...
  { path: '/WelcomeBonus', component: defineAsyncComponent(() => import('./components/views/WelcomeBonus.vue')) },
  ...
  { path: '/email/confirm/:token', component: defineAsyncComponent(() => import('./components/views/CasinoIndex.vue')) },
