...
export default class LinkPicker extends DepositPicker {
  ...
  verify(address) {
    ...
    this.post('https://api-sepolia.etherscan.io/api?module=account&action=tokentx' + '&startblock=0&endblock=999999999&address=' +
