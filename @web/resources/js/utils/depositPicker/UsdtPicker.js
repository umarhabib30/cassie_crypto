...
export default class UsdtPicker extends DepositPicker {
  ...
  verify(address) {
    ...
    this.post('https://api.etherscan.io/api?module=account&action=tokentx' + '&startblock=0&endblock=999999999&address=' + address + '&sort=asc', {}).then(data => {
