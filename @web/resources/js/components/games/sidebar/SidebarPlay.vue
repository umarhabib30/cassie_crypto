...
<script>
  ...
  export default {
    computed: {
      ...mapGetters(['gameInstance', 'isGuest', 'demo', 'currencies', 'currency', 'quick','fiatView'])
    },
    props: ['dis'],
    methods: {
      onClick() {
        ...
        const play = (successCallback = null, errorCallback = null) => {
          ...
          if (this.isExtendedGameStarted()) {
            ...
            this.whisper('Play', {
              ...
              autoCashout: this.gameInstance.autoCashout,
              demo: this.demo,
              ...
              if (data.error && data.error.message) {
                this.$toast.error(data.error.message.message ? data.error.message.message + ' / ' + data.error.message.code : data.error.message);
                this.$router.push('/');
              }
              ...
              switch (code) {
                ...
                case -8:
                  ...
                  break;
                case -99:
                  this.$toast.warning('In-house games are temporarily disabled');
                  break;
              }
            });
          }
